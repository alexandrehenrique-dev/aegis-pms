 ...
 * (referencia obrigatoria a um Form real) e {@code download} (lista nunca
 * vazia) exigiam relaxar essa validacao para aceitar o estado "ainda nao
 * configurado" — decisao registrada em {@code SPRINT-RESULTADO.md} (Etapa 26).
 */
public final class BlockDefaults {
    ...
    private static Map<BlockType, Map<String, Object>> buildDefaults() {
        ...
        defaults.put(BlockType.IMAGE, Map.of("alt", "Imagem"));
        ...
        // espelhando o frontend. Cada um exige referencia externa real ou uma
        // contagem minima de itens que hoje nao tem estado vazio possivel.
        ...
        defaults.put(BlockType.VIDEO_GALLERY, Map.of(KEY_ITEMS, List.of()));
