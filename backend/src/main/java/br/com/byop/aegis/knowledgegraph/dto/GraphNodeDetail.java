...
public record GraphNodeDetail(
    ...
    public GraphNodeDetail(UUID id, UUID tenantId, UUID productId, GraphNodeType nodeType, String refType,
                           String refId, String label, String slug, String metadataJson, OffsetDateTime createdAt,
                           OffsetDateTime updatedAt) {
        this(id, tenantId, productId, nodeType, refType, refId, label, slug, nodeType.name(), "ativo", 0.0, 0.0,
                List.of(), metadataJson, createdAt, updatedAt);
    }
}
