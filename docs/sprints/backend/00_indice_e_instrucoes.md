...
| `22_dominio_pages_secoes_e_blocos.md` | Trace, Seção D.1 (Sprint 11 do frontend) | Domínio `pages`: páginas compostas por seções/blocos tipados (hero, card-list, gallery, contact...) — pré-requisito: etapas 11, 12 e 13; pode ser feita a qualquer momento depois delas, numerada por último por ter sido adicionada depois |
