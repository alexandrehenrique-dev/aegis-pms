...
export function ConfirmDialog({ title, desc, onConfirm, onCancel, danger = false, loading = false }: { title: string; desc: string; onConfirm: () => void; onCancel: () => void; danger?: boolean; loading?: boolean }) {
  return (
