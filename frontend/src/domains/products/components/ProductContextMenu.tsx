...
/** Menu de contexto (botão direito) sobre um card/linha de produto — atalho para Editar/Excluir, útil sobretudo em produtos bloqueados/sem módulos que não podem ser abertos. */
