import { Badge, Button, Card, EmptyState, PageHeader, PartialErrorWidget, PermissionHint, SkeletonLines } from "../../../shared/components/Primitives";
import { assetsService } from "../services/assetsService";
import { useAsyncData } from "../../../shared/hooks/useAsyncData";

export function AssetTagManager() {
  const { data: assetTags, loading, error } = useAsyncData(() => assetsService.listTags(), []);
  ...
  return (
    <>
      ...
      {loading ? <SkeletonLines /> : error || !assetTags ? <PartialErrorWidget /> : (
